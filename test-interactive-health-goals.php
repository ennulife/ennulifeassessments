...
if (file_exists($health_goals_config)) {
    ...
    echo "<strong>Goal Definitions:</strong> " . count($config['goal_definitions'] ?? []) . " goals<br>";
    echo "<strong>Goal-to-Pillar Map:</strong> " . count($config['goal_to_pillar_map'] ?? []) . " mappings<br>";
...
if (class_exists('ENNU_Intentionality_Engine')) {
    ...
    $user_goals = ['energy', 'strength', 'sleep'];
