<?php
/**
 * AI Medical Team Research Trigger Script
 * 
 * This script triggers the AI Medical Team to perform research on reference ranges
...
if (!class_exists('ENNU_Life_Plugin')) {
    echo "ERROR: ENNU Life Plugin class not found\n";
    exit(1);
}

// Get the plugin instance
$plugin = ENNU_Life_Plugin::get_instance();
...
// Get the AI Medical Team
$ai_team = $plugin->get_ai_medical_team();
