...
jQuery( document ).ready(
	function ($) {
		...
		function initAdminTabs() {
			...
			console.log( 'ENNU Admin: Found ' + tabContainers.length + ' tab containers' );
			if ( ! tabContainers.length) {
				console.log( 'ENNU Admin: No tab containers found' );
				return;
			}
			...
			tabContainers.each(
				function () {
					...
					tabLinks.on(
						'click',
						function (e) {
							console.log( 'ENNU Admin: Tab clicked: ' + $( this ).attr( 'href' ) );
							e.preventDefault();
							...
							console.log( 'ENNU Admin: Tab switched to: ' + targetId );
