...
if ($admin) {
    ...
    $test_data = array(
        ...
        'ennu_global_height_weight' => array('ft' => '5', 'in' => '8', 'weight' => '140')
    );
...
$_POST['ennu_global_height_weight'] = array('ft' => '6', 'in' => '0', 'weight' => '180');
...
if ($admin && method_exists($admin, 'save_user_assessment_fields')) {
    ...
    $form_data = array(
        ...
        'ennu_global_height_weight' => array('ft' => '6', 'in' => '0', 'weight' => '180')
    );
