...
(function($) {
    ...
    class ENNUAssessmentForm {
        ...
        init() {
            ...
            // DOB is no longer the first question in all assessments. Age calculation should be triggered by the event handler.
            this.bindEvents();
        }
        ...
        bindEvents() {
            ...
            this.form.on('change', 'input[type="radio"]', (e) => {
                // NEVER auto-advance on the welcome assessment.
                if (this.form.data('assessment') === 'welcome_assessment') {
                    return;
                }
        ...
        showQuestion(step, direction = 'next') {
            ...
            // --- AUTO-SKIP LOGIC ---
            // Do not auto-skip the health goals question
            if (currentSlide.data('question-key') === 'welcome_q3') {
                return;
            }
        ...
        calculateAge() {
            // Specifically, do not run this logic for the welcome assessment, which is now manual.
            if (this.form.data('assessment') === 'welcome_assessment') {
                this.combineDOB(); // Still combine the date, just don't advance.
                return;
            }
            ...
            if (month && day && year) {
                ...
                if (age >= 0) {
                    ...
                    // Restore original auto-advance for all other assessments
