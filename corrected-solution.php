<?php
/**
 * Corrected Solution - PROPER ASSESSMENT NAMES
 * 
 * Uses the correct assessment names and mappings
 */
...
echo "<h1>ENNU Corrected Solution - PROPER ASSESSMENT NAMES</h1>\n";

// Step 1: Create all pages with CORRECT names
echo "<h2>Step 1: Creating All Pages with CORRECT Names</h2>\n";
...
$pages_to_create = array(
    ...
    // CORRECT ASSESSMENT NAMES (using hyphens for shortcodes)
    'assessments/hair' => array( 'title' => 'Hair Assessment', 'shortcode' => '[ennu-hair]' ),
    ...
    'assessments/skin' => array( 'title' => 'Skin Assessment', 'shortcode' => '[ennu-skin]' ),
    ...
    // Sub-pages with CORRECT shortcodes
    'assessments/hair/results' => array( 'title' => 'Hair Assessment Results', 'shortcode' => '[ennu-hair-results]' ),
    'assessments/hair/details' => array( 'title' => 'Hair Assessment Details', 'shortcode' => '[ennu-hair-assessment-details]' ),
    'assessments/hair/consultation' => array( 'title' => 'Hair Consultation', 'shortcode' => '[ennu-hair-consultation]' ),
    'assessments/ed-treatment/results' => array( 'title' => 'ED Treatment Assessment Results', 'shortcode' => '[ennu-ed-treatment-results]' ),
    'assessments/ed-treatment/details' => array( 'title' => 'ED Treatment Assessment Details', 'shortcode' => '[ennu-ed-treatment-assessment-details]' ),
    ...
    'assessments/weight-loss/details' => array( 'title' => 'Weight Loss Assessment Details', 'shortcode' => '[ennu-weight-loss-assessment-details]' ),
    ...
    'assessments/health/details' => array( 'title' => 'Health Assessment Details', 'shortcode' => '[ennu-health-assessment-details]' ),
    ...
    'assessments/health-optimization/details' => array( 'title' => 'Health Optimization Details', 'shortcode' => '[ennu-health-optimization-assessment-details]' ),
    ...
    'assessments/skin/results' => array( 'title' => 'Skin Assessment Results', 'shortcode' => '[ennu-skin-results]' ),
    'assessments/skin/details' => array( 'title' => 'Skin Assessment Details', 'shortcode' => '[ennu-skin-assessment-details]' ),
    'assessments/skin/consultation' => array( 'title' => 'Skin Consultation', 'shortcode' => '[ennu-skin-consultation]' ),
    'assessments/hormone/results' => array( 'title' => 'Hormone Assessment Results', 'shortcode' => '[ennu-hormone-results]' ),
    'assessments/hormone/details' => array( 'title' => 'Hormone Assessment Details', 'shortcode' => '[ennu-hormone-assessment-details]' ),
    ...
    'assessments/testosterone/details' => array( 'title' => 'Testosterone Assessment Details', 'shortcode' => '[ennu-testosterone-assessment-details]' ),
    ...
    'assessments/menopause/details' => array( 'title' => 'Menopause Assessment Details', 'shortcode' => '[ennu-menopause-assessment-details]' ),
    ...
    'assessments/sleep/details' => array( 'title' => 'Sleep Assessment Details', 'shortcode' => '[ennu-sleep-assessment-details]' ),
...
// Step 3: Simple selection JavaScript (NO REFRESH)
echo "<h2>Step 3: Simple Selection JavaScript (NO REFRESH)</h2>\n";

echo "<script>
jQuery(document).ready(function($) {
    console.log('ENNU Corrected Solution: Starting simple selection');
    ...
    function selectPages() {
        $.each(createdPages, function(key, pageId) {
            ...
            if (dropdown.length) {
                ...
                selectedCount++;
                console.log('ENNU Corrected Solution: Selected page ' + pageId + ' for key ' + key);
            }
        });
        
        console.log('ENNU Corrected Solution: Selected ' + selectedCount + ' pages');
        return selectedCount;
    }
    
    // Try selection
    var count = selectPages();
    
    if (count > 0) {
        alert('ENNU Corrected Solution: Successfully selected ' + count + ' pages!');
    }
});
</script>";

echo "<p>✅ Simple selection JavaScript loaded (NO REFRESH)</p>\n";
...
echo "<h2>Step 5: Assessment Key Mapping</h2>\n";
echo "<p><strong>CORRECT ASSESSMENT KEYS:</strong></p>\n";
echo "<ul>\n";
echo "<li>hair_assessment → [ennu-hair]</li>\n";
echo "<li>ed_treatment_assessment → [ennu-ed-treatment]</li>\n";
echo "<li>weight_loss_assessment → [ennu-weight-loss]</li>\n";
echo "<li>health_assessment → [ennu-health]</li>\n";
echo "<li>skin_assessment → [ennu-skin]</li>\n";
echo "<li>hormone_assessment → [ennu-hormone]</li>\n";
echo "<li>testosterone_assessment → [ennu-testosterone]</li>\n";
echo "<li>menopause_assessment → [ennu-menopause]</li>\n";
echo "<li>sleep_assessment → [ennu-sleep]</li>\n";
echo "</ul>\n";
...
echo "<p>3. <strong>NO AUTOMATIC REFRESH</strong> - the page will stay put!</p>\n";

echo "<h2>Step 7: Manual Verification</h2>\n";
echo "<p>If auto-selection doesn't work, manually select the pages:</p>\n";
echo "<ol>\n";
foreach ( $created_pages as $path => $page_id ) {
    echo "<li>Go to ENNU Settings</li>\n";
    echo "<li>Find the dropdown for: {$path}</li>\n";
    echo "<li>Select page ID: {$page_id}</li>\n";
