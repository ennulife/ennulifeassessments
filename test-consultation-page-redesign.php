...
foreach ($consultation_types as $type => $title) {
    ...
    $configs = array(
        'hair_restoration' => array('color' => '#667eea', 'gradient' => 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', 'icon' => '🦱'),
        'ed_treatment' => array('color' => '#f093fb', 'gradient' => 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', 'icon' => '🔒'),
        'weight_loss' => array('color' => '#4facfe', 'gradient' => 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', 'icon' => '⚖️'),
        'health_optimization' => array('color' => '#fa709a', 'gradient' => 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)', 'icon' => '🏥'),
        'skin_care' => array('color' => '#a8edea', 'gradient' => 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)', 'icon' => '✨'),
        'general_consultation' => array('color' => '#667eea', 'gradient' => 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', 'icon' => '👨‍⚕️'),
        'schedule_call' => array('color' => '#4facfe', 'gradient' => 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', 'icon' => '📞'),
        'ennu_life_score' => array('color' => '#fa709a', 'gradient' => 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)', 'icon' => '📊'),
        'health_optimization_results' => array('color' => '#fa709a', 'gradient' => 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)', 'icon' => '📈'),
        'confidential_consultation' => array('color' => '#f093fb', 'gradient' => 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', 'icon' => '🔒')
    );
    
    $config = $configs[$type] ?? array('color' => '#667eea', 'gradient' => 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', 'icon' => '📋');
