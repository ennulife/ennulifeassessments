...
class DataAccessControlTest extends WP_UnitTestCase {
    ...
    public function setUp(): void {
        ...
        $this->test_user_id = self::factory()->user->create(array(
            'user_email' => 'testuser@example.com',
            'user_login' => 'testuser',
            'role' => 'subscriber'
        ));
        
        $this->admin_user_id = self::factory()->user->create(array(
    ...
    public function test_assessment_data_access_control() {
        update_user_meta($this->test_user_id, 'ennu_hair_assessment_scores', array(
            'overall_score' => 7.5,
