...
class Test_ENNU_Scoring_System extends WP_UnitTestCase {
    ...
    public function test_intentionality_engine() {
        ...
        $boosted_scores = $engine->apply_goal_alignment_boost( $this->user_id, array(
            'body' => 70,
            'mind' => 75,
            'lifestyle' => 80,
            'aesthetics' => 65
    ...
    public function test_new_life_score_calculation() {
        ...
        update_user_meta( $this->user_id, 'ennu_biomarker_data', array(
            'testosterone' => array( 'value' => 300, 'unit' => 'ng/dL' ),
            'vitamin_d' => array( 'value' => 20, 'unit' => 'ng/mL' )
        ) );
        update_user_meta( $this->user_id, 'ennu_doctor_targets', array(
            'testosterone' => 500,
            'vitamin_d' => 40
        ) );
