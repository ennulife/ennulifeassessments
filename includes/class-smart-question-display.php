...
class ENNU_Smart_Question_Display {
    ...
    public static function enqueue_scripts() {
        ...
        wp_localize_script( 'ennu-smart-question-display', 'ennuSmartQuestions', array(
    ...
    private static function apply_smart_ordering( $questions, $user_data, $user_answers ) {
        ...
        uasort( $ordered_questions, function( $a, $b ) use ( $user_data ) {
    ...
    private static function get_question_relevance_rules() {
        return array(
            'testosterone_symptoms' => array(
                array( 'type' => 'gender', 'value' => array( 'male', 'non_binary' ) ),
                array( 'type' => 'age', 'min' => 18 )
            ),
            'menopause_symptoms' => array(
                array( 'type' => 'gender', 'value' => array( 'female', 'non_binary' ) ),
                array( 'type' => 'age', 'min' => 35 )
            ),
            'pregnancy_related' => array(
                array( 'type' => 'gender', 'value' => array( 'female' ) ),
                array( 'type' => 'age', 'min' => 18, 'max' => 50 )
            )
        );
    }
