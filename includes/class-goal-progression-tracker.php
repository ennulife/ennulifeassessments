		...
		return array(
			'lose_weight'     => array(
				...
				'levels'              => array(
					'good'   => array(
						'min_score'   => 60,
						'description' => 'Initial weight loss progress',
					),
					'better' => array(
						'min_score'   => 75,
						'description' => 'Significant weight loss achieved',
					),
					'best'   => array(
						'min_score'   => 85,
						'description' => 'Optimal weight management',
					),
				),
			...
			'build_muscle'    => array(
				...
				'levels'              => array(
					'good'   => array(
						'min_score'   => 65,
						'description' => 'Muscle building foundation',
					),
					'better' => array(
						'min_score'   => 78,
						'description' => 'Noticeable muscle gains',
					),
					'best'   => array(
						'min_score'   => 88,
						'description' => 'Optimal muscle development',
					),
				),
			...
			'improve_energy'  => array(
				...
				'levels'              => array(
					'good'   => array(
						'min_score'   => 62,
						'description' => 'Improved daily energy',
					),
					'better' => array(
						'min_score'   => 76,
						'description' => 'Sustained energy levels',
					),
					'best'   => array(
						'min_score'   => 87,
						'description' => 'Optimal energy and vitality',
					),
				),
			...
			'enhance_mood'    => array(
				...
				'levels'              => array(
					'good'   => array(
						'min_score'   => 64,
						'description' => 'Mood stability improvement',
					),
					'better' => array(
						'min_score'   => 77,
						'description' => 'Consistent positive mood',
					),
					'best'   => array(
						'min_score'   => 86,
						'description' => 'Optimal emotional well-being',
					),
				),
			...
			'improve_sleep'   => array(
				...
				'levels'              => array(
					...
					'better' => array(
						'min_score'   => 79,
						'description' => 'Consistent restful sleep',
					),
					'best'   => array(
						'min_score'   => 89,
						'description' => 'Optimal sleep patterns',
					),
				),
			...
			'increase_libido' => array(
				...
				'levels'              => array(
					'good'   => array(
						'min_score'   => 63,
						'description' => 'Improved sexual interest',
					),
					'better' => array(
						'min_score'   => 76,
						'description' => 'Healthy libido levels',
					),
					'best'   => array(
						'min_score'   => 85,
						'description' => 'Optimal sexual health',
					),
				),
			...
			'longevity'       => array(
				...
				'levels'              => array(
					'good'   => array(
						'min_score'   => 68,
						'description' => 'Longevity foundation established',
					),
					'better' => array(
						'min_score'   => 80,
						'description' => 'Strong longevity markers',
					),
					'best'   => array(
						'min_score'   => 90,
						'description' => 'Optimal longevity potential',
					),
				),
		...
		$recommendations_map = array(
			'lose_weight'    => array(
				'none' => array(
					array(
						'type'     => 'assessment',
						'title'    => 'Complete Weight Loss Assessment',
						'priority' => 'high',
					),
					array(
						'type'     => 'action',
						'title'    => 'Set realistic weight loss targets',
						'priority' => 'medium',
					),
				),
				'good' => array(
					...
					array(
						'type'     => 'biomarker',
						'title'    => 'Monitor metabolic markers',
						'priority' => 'medium',
					),
				),
			),
			'build_muscle'   => array(
				'none' => array(
					array(
						'type'     => 'assessment',
						'title'    => 'Complete Testosterone Assessment',
						'priority' => 'high',
					),
					array(
						'type'     => 'action',
						'title'    => 'Start resistance training program',
						'priority' => 'high',
					),
				),
				'good' => array(
					array(
						'type'     => 'biomarker',
						'title'    => 'Check testosterone levels',
						'priority' => 'high',
					),
					array(
						'type'     => 'action',
			...
			'improve_energy' => array(
				...
				'good' => array(
					...
					array(
						'type'     => 'biomarker',
						'title'    => 'Monitor vitamin D levels',
						'priority' => 'medium',
					),
				),
			),
