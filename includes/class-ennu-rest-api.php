	...
	public static function get_assessments( $request ) {
		$assessments = array(
			'testosterone' => array(
				...
				'description' => 'Comprehensive testosterone health evaluation',
			),
			'menopause'    => array(
				'title'       => 'Menopause Assessment',
				'description' => 'Menopause symptoms and hormone evaluation',
			),
			'ed_treatment' => array(
				'title'       => 'ED Treatment Assessment',
				'description' => 'Erectile dysfunction evaluation and treatment options',
			),
			'weight_loss'  => array(
				'title'       => 'Weight Loss Assessment',
				'description' => 'Comprehensive weight management evaluation',
			),
			'longevity'    => array(
				'title'       => 'Longevity Assessment',
				'description' => 'Longevity and healthy aging evaluation',
			),
			'hair'         => array(
				'title'       => 'Hair Health Assessment',
				'description' => 'Hair loss and scalp health evaluation',
			),
			'skin'         => array(
				'title'       => 'Skin Health Assessment',
				'description' => 'Skin health and anti-aging evaluation',
			),
			'health'       => array(
			...
			'sleep'        => array(
				...
				'description' => 'Sleep quality and disorders evaluation',
			),
		);
