...
final class ENNU_Assessment_Shortcodes {
	...
	public function register_shortcodes() {
		...
		error_log( 'ENNU Shortcodes: Registered core shortcodes: ennu-user-dashboard, ennu-assessment-results, ennu-assessments, ennu-signup, scorepresentation' );
  ...
  <!-- End of Meetings Embed Script -->';
		...
		<style>
		/* ENNU Header styles for consultation page */
		.ennu-unified-container .ennu-header-container {
		...
		.ennu-unified-container .ennu-header-container::before {
			content: '';
			position: absolute;
			top: 0;
			left: 0;
		...
		.ennu-unified-container .ennu-header-title {
		...
		.ennu-unified-container .ennu-header-subtitle {
		...
		.ennu-unified-container .ennu-logo {
			height: 35px;
			width: auto;
	...
	public function render_score_presentation( $atts, $content = '', $tag = '' ) {
		...
		$mind_score = get_user_meta( $user_id, 'ennu_pillar_mind_score', true ) ?: 0;
		$body_score = get_user_meta( $user_id, 'ennu_pillar_body_score', true ) ?: 0;
		$lifestyle_score = get_user_meta( $user_id, 'ennu_pillar_lifestyle_score', true ) ?: 0;
		$aesthetics_score = get_user_meta( $user_id, 'ennu_pillar_aesthetics_score', true ) ?: 0;
