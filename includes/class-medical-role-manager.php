...
class ENNU_Medical_Role_Manager {
    ...
    public static function create_medical_roles() {
        ...
        if ( ! $medical_director ) {
            add_role( 'ennu_medical_director', 'Medical Director', array(
                'read' => true,
                'edit_posts' => false,
                'delete_posts' => false,
                'publish_posts' => false,
        ...
        if ( ! $medical_provider ) {
            add_role( 'ennu_medical_provider', 'Medical Provider', array(
                'read' => true,
                'edit_posts' => false,
                'delete_posts' => false,
                'publish_posts' => false,
    ...
    public static function assign_medical_role( $user_id, $role ) {
        ...
        self::log_medical_action( get_current_user_id(), 'role_assigned', array(
    ...
    public static function remove_medical_role( $user_id ) {
        ...
        if ( ! empty( $removed_roles ) ) {
            self::log_medical_action( get_current_user_id(), 'role_removed', array(
                'target_user_id' => $user_id,
    ...
    private static function get_user_medical_actions_count( $user_id, $days ) {
        ...
        $recent_actions = array_filter( $actions_log, function( $action ) use ( $cutoff_date ) {
    ...
    public static function get_medical_audit_log( $limit = 50 ) {
        ...
        usort( $global_audit, function( $a, $b ) {
