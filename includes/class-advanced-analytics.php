...
class ENNU_Advanced_Analytics {
    ...
    public function track_page_view() {
        ...
        $this->track_event('page_view', 'navigation', 'page_view', get_the_title(), 0, array(
    ...
    public function track_user_login($user_login, $user) {
        ...
        $this->track_event('user_action', 'authentication', 'login', $user_login, 0, array(
            'user_id' => $user->ID,
    ...
    public function track_user_registration($user_id) {
        ...
        $this->track_event('conversion', 'registration', 'user_registered', $user->user_login, 1, array(
            'user_id' => $user_id,
    ...
    public function track_assessment_start($assessment_type, $user_id) {
        $this->track_event('assessment', 'engagement', 'assessment_started', $assessment_type, 0, array(
    ...
    public function track_assessment_completion($assessment_type, $user_id, $score) {
        $this->track_event('conversion', 'assessment', 'assessment_completed', $assessment_type, $score, array(
            'assessment_type' => $assessment_type,
            'user_id' => $user_id,
            'score' => $score
        ));
    ...
    public function track_assessment_abandonment($assessment_type, $user_id) {
        $this->track_event('engagement', 'assessment', 'assessment_abandoned', $assessment_type, 0, array(
            'assessment_type' => $assessment_type,
            'user_id' => $user_id
        ));
    }
    ...
    public function track_biomarker_update($biomarker_type, $user_id) {
        $this->track_event('engagement', 'biomarker', 'biomarker_updated', $biomarker_type, 0, array(
    ...
    public function track_health_goal_creation($goal_type, $user_id) {
        $this->track_event('engagement', 'health_goal', 'goal_created', $goal_type, 0, array(
            'goal_type' => $goal_type,
            'user_id' => $user_id
        ));
    }
    ...
    public function track_health_goal_completion($goal_type, $user_id) {
        $this->track_event('conversion', 'health_goal', 'goal_completed', $goal_type, 1, array(
            'goal_type' => $goal_type,
            'user_id' => $user_id
        ));
    }
    ...
    public function track_dashboard_view() {
        $this->track_event('engagement', 'dashboard', 'dashboard_viewed', '', 0, array(
    ...
    public function track_score_view($score_type, $user_id) {
        $this->track_event('engagement', 'score', 'score_viewed', $score_type, 0, array(
    ...
    public function track_report_download($report_type, $user_id) {
        $this->track_event('conversion', 'report', 'report_downloaded', $report_type, 1, array(
