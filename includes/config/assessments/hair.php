...
return array(
	...
	'questions'         => array(
		...
		'hair_symptoms' => array(
			'title'    => 'Select any symptoms related to your hair health:',
			'type'     => 'multiselect',
			'options'  => array(
				'hair_loss'         => 'Hair loss or thinning',
				'brittle_hair'      => 'Brittle or breaking hair',
				'slow_growth'       => 'Slow hair growth',
				'dry_scalp'         => 'Dry or itchy scalp',
				'oily_scalp'        => 'Oily scalp',
				'dandruff'          => 'Dandruff or flaking',
				'premature_graying' => 'Premature graying',
				'thyroid_issues'    => 'Known thyroid problems',
				'stress'            => 'High stress levels',
				'none'              => 'None of the above',
			),
			'scoring'  => array(
				'category' => 'Hair Health Symptoms',
				'weight'   => 2,
				'answers'  => array(
					'hair_loss'         => 1,
					'brittle_hair'      => 2,
