...
return array(
	...
	'Brain Health'          => array(
		'apoe_genotype' => array(
			'unit'              => 'genotype',
			'range'             => 'E2/E2, E2/E3, E3/E3, E3/E4, E4/E4',
			'optimal_range'     => 'E2/E2, E2/E3, E3/E3',
			'suboptimal_range'  => 'E3/E4',
			'poor_range'        => 'E4/E4',
			...
			'pillar_impact'     => array( 'Mind', 'Body' ),
			'frequency'         => 'once_lifetime',
			'required_for'      => array( 'Guardian Panel', 'Cognitive & Energy Panel' ),
		),
		'ptau_217' => array(
			'unit'              => 'pg/mL',
			'range'             => 'varies_by_age',
			...
			'pillar_impact'     => array( 'Mind', 'Body' ),
			'frequency'         => 'annually',
			'required_for'      => array( 'Guardian Panel' ),
		),
	...
	'Advanced Cardiovascular' => array(
		'tmao' => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Protector Panel' ),
		),
		...
		'ferritin' => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Protector Panel', 'Cognitive & Energy Panel' ),
		),
		'one_five_ag' => array(
			'unit'              => 'µg/mL',
			'range'             => '>14',
			'optimal_range'     => '>14',
			'suboptimal_range'  => '10-14',
			'poor_range'        => '<10',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'blood_draw',
			'health_vectors'    => array(
	...
	'Metabolic Health'      => array(
		'insulin' => array(
			'unit'              => 'µIU/mL',
			'range'             => '3-15',
			'optimal_range'     => '3-15',
			'suboptimal_range'  => '15-25',
			'poor_range'        => '>25',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'fasting_blood_draw',
			'health_vectors'    => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Catalyst Panel', 'Metabolic Optimization Panel' ),
		),
		'glycomark' => array(
			'unit'              => 'µg/mL',
			'range'             => '>14',
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Catalyst Panel' ),
		),
		'uric_acid' => array(
			'unit'              => 'mg/dL',
			'range'             => '3.4-6.0',
			'optimal_range'     => '3.4-6.0',
			'suboptimal_range'  => '6.0-7.0',
			'poor_range'        => '>7.0',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'blood_draw',
			'health_vectors'    => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Catalyst Panel', 'Longevity & Performance Panel' ),
		),
		'adiponectin' => array(
			'unit'              => 'µg/mL',
			'range'             => 'varies_by_bmi',
	...
	'Toxicity Assessment'   => array(
		'arsenic' => array(
			...
			'pillar_impact'     => array( 'Body', 'Mind' ),
			'frequency'         => 'annually',
			'required_for'      => array( 'Detoxifier Panel', 'Cognitive & Energy Panel' ),
		),
		'lead' => array(
			'unit'              => 'µg/dL',
			'range'             => '<3.5',
			'optimal_range'     => '<3.5',
			'suboptimal_range'  => '3.5-5.0',
			'poor_range'        => '>5.0',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'blood_draw',
			'health_vectors'    => array(
	...
	'Advanced Hormones'     => array(
		'estradiol' => array(
			...
			'pillar_impact'     => array( 'Body', 'Mind' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Hormone Optimization Panel' ),
		),
		'progesterone' => array(
			'unit'              => 'ng/mL',
			'range'             => '0.1-0.8',
	...
	'Elite Cardiovascular' => array(
		'apob' => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Cardiovascular Health Panel' ),
		),
		'hs_crp' => array(
			'unit'              => 'mg/L',
			'range'             => '<1.0',
	...
	'Longevity & Performance' => array(
		'telomere_length' => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'annually',
			'required_for'      => array( 'Longevity & Performance Panel' ),
		),
		'nad' => array(
			'unit'              => 'µM',
			'range'             => 'varies_by_age',
		...
		'grip_strength' => array(
			...
			'poor_range'        => 'varies_by_age_gender',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'physical_assessment',
			'health_vectors'    => array(
				'Strength'         => 0.9,
				'Longevity'        => 0.8,
				'Energy'           => 0.7,
	...
	'Cognitive & Energy'    => array(
		'coq10' => array(
			'unit'              => 'µg/mL',
			'range'             => '1.0-2.0',
			'optimal_range'     => '1.0-2.0',
			'suboptimal_range'  => '0.5-1.0_or_2.0-3.0',
			'poor_range'        => '<0.5_or_>3.0',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'blood_draw',
			'health_vectors'    => array(
				'Energy'           => 0.8,
			...
			'pillar_impact'     => array( 'Body', 'Mind' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Cognitive & Energy Panel' ),
		),
		'heavy_metals_panel' => array(
			'unit'              => 'varied',
			'range'             => 'below_threshold',
	...
	'Advanced Metabolic'    => array(
		'fasting_insulin' => array(
			...
			'pillar_impact'     => array( 'Body', 'Lifestyle' ),
			'frequency'         => 'quarterly',
			'required_for'      => array( 'Metabolic Optimization Panel' ),
		),
		'homa_ir' => array(
			'unit'              => 'index',
			'range'             => '<1.0',
		...
		'blood_pressure' => array(
			...
			'range'             => '<120/80',
			'optimal_range'     => '<120/80',
			'suboptimal_range'  => '120-139/80-89',
			'poor_range'        => '≥140/90',
			'source'            => 'ENNU Physical Assessment',
			'collection_method' => 'automated_or_manual_cuff',
			'health_vectors'    => array(
			...
			'pillar_impact'     => array( 'Body' ),
			'frequency'         => 'monthly',
			'required_for'      => array( 'Foundation Panel' ),
		),
		'neck_measurement' => array(
			'unit'              => 'inches',
			'range'             => '<14 women/<17 men',
			'optimal_range'     => '<14 women/<17 men',
			'suboptimal_range'  => '14-16 women/17-19 men',
			'poor_range'        => '>16 women/>19 men',
			'source'            => 'ENNU Physical Assessment',
			'collection_method' => 'physical_measurement',
			'health_vectors'    => array(
				'Weight Loss'      => 0.7,
				'Heart Health'     => 0.6,
			),
		...
		'testosterone_free' => array(
			'unit'              => 'pg/mL',
			'range'             => 'varies_by_age_sex',
			'optimal_range'     => 'varies_by_age_sex',
			'suboptimal_range'  => 'varies_by_age_sex',
			'poor_range'        => 'varies_by_age_sex',
			'source'            => 'Advanced Lab Partners',
			'collection_method' => 'blood_draw',
			'health_vectors'    => array(
				'Hormones'         => 0.9,
		...
		'waist_measurement' => array(
			'unit'              => 'inches',
			'range'             => '<35 women/<40 men',
			'optimal_range'     => '<35 women/<40 men',
			'suboptimal_range'  => '35-40 women/40-45 men',
			'poor_range'        => '>40 women/>45 men',
			'source'            => 'ENNU Physical Assessment',
			'collection_method' => 'physical_measurement',
			'health_vectors'    => array(
				'Weight Loss'      => 0.8,
