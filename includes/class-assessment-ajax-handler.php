...
class ENNU_Assessment_AJAX_Handler {
	...
	public function handle_assessment_submission() {
		// Use the same comprehensive logic as the main assessment shortcodes
		if ( class_exists( 'ENNU_Assessment_Shortcodes' ) ) {
			$shortcodes = new ENNU_Assessment_Shortcodes();
			return $shortcodes->handle_assessment_submission();
		}
	...
	private function calculate_scores( $user_id, $form_data ) {
		...
		// Create calculator with required parameters
		$calculator = new ENNU_Assessment_Calculator( $assessment_type, $form_data, $all_definitions );
	...
	private function get_results_url( $token ) {
		// Use the same logic as the main assessment shortcodes
		if ( class_exists( 'ENNU_Assessment_Shortcodes' ) ) {
			$shortcodes = new ENNU_Assessment_Shortcodes();
			return $shortcodes->get_thank_you_url( 'hair', $token );
		}

		// Fallback to query parameters if shortcodes class not available
