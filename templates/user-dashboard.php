										...
										<div class="assessment-card-body">
											...
											<div class="assessment-card-actions">
												<?php if ( $assessment['completed'] ) : ?>
													...
													<a href="<?php echo esc_url( $shortcode_instance->get_page_id_url( str_replace( '_assessment', '-assessment-details', $assessment['key'] ) ) ); ?>" class="btn btn-history">History</a>
												<?php else : ?>
													...
													<div class="incomplete-actions-row">
														...
														<a href="<?php echo esc_url( $shortcode_instance->get_page_id_url( str_replace( '_', '-', $assessment['key'] ) ) ); ?>" class="btn btn-primary btn-pill">Start Assessment</a>
													</div>
												<?php endif; ?>
											</div>
											...
											<?php if ( $assessment['completed'] ) : ?>
												<div class="assessment-retake-link">
													<a href="<?php echo esc_url( $shortcode_instance->get_page_id_url( str_replace( '_', '-', $assessment['key'] ) ) ); ?>">Retake Assessment</a>
												</div>
											<?php endif; ?>
										</div>
									</div>
