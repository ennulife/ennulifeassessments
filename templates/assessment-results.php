	...
	<div class="dossier-grid">
		<aside class="dossier-sidebar">
			...
			<div class="assessment-actions-footer" style="padding-top: 15px; border-top: 1px solid var(--border-color); margin-top: 15px; display: flex; flex-direction: column; gap: 10px;">
				...
				<a href="<?php echo esc_url( $shortcode_instance->get_page_id_url( 'call' ) ); ?>" class="action-button button-report" style="flex: 1; text-align: center; background-color: var(--accent-secondary); color: #fff; padding: 10px; text-decoration: none; border-radius: 0.375rem; font-weight: 600; transition: all 0.2s ease; font-size: 0.9rem;">Schedule a Call</a>
