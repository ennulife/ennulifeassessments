	...
	<div class="dossier-grid">
		<aside class="dossier-sidebar">
			...
			<div class="assessment-actions-footer" style="padding-top: 15px; border-top: 1px solid var(--border-color); margin-top: 15px; display: flex; flex-direction: column; gap: 10px;">
				<a href="<?php echo esc_url( $details_button_url ); ?>" class="action-button button-report" style="flex: 1; text-align: center; background-color: var(--accent-primary); color: #fff; padding: 10px; text-decoration: none; border-radius: 0.375rem; font-weight: 600; transition: all 0.2s ease; font-size: 0.9rem;">View Assessment Results</a>
				<a href="<?php echo esc_url( $dashboard_button_url ); ?>" class="action-button button-retake" style="flex: 1; text-align: center; background-color: var(--card-bg); color: var(--text-light); border: 1px solid var(--border-color); padding: 10px; text-decoration: none; border-radius: 0.375rem; font-weight: 600; transition: all 0.2s ease; font-size: 0.9rem;">View My ENNU LIFE Dashboard</a>
				<a href="<?php echo esc_url( $retake_url ); ?>" class="action-button button-retake" style="flex: 1; text-align: center; background-color: var(--card-bg); color: var(--text-light); border: 1px solid var(--border-color); padding: 10px; text-decoration: none; border-radius: 0.375rem; font-weight: 600; transition: all 0.2s ease; font-size: 0.9rem;">Take Test Again</a>
				<hr style="border-color: var(--border-color); width: 50%; margin: 10px auto;">
				<a href="<?php echo esc_url( home_url( '/?page_id=189' ) ); ?>" class="action-button button-report" style="flex: 1; text-align: center; background-color: var(--accent-secondary); color: #fff; padding: 10px; text-decoration: none; border-radius: 0.375rem; font-weight: 600; transition: all 0.2s ease; font-size: 0.9rem;">Schedule a Call</a>
